  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img :src="$store.state.user.getUser.staffPhoto ">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ $store.state.user.getUser.username }}，祝你开心每一天！</p>
            <p class="lastChild">早安，{{ $store.state.user.getUser.username }}，祝你开心每一天！</p>
          </div>
        </div>
        <div class="fr" />
      </div>
...
export default {
  ...
  created() {
    // console.log(this.$store.state.user.getUser.username)
  }
}
</script>
